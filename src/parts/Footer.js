                ...
                <div className="row">
                    ...
                    <h6 className="mt-2">Explore Us</h6>
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">
                                <Button type="link" href="/terms">Terms & Conditioners</Button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <h6 className="mt-2">Connect Us</h6>
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                <Button isExternal type="link" href="support@staycation.id">support@staycation.id</Button>
                            </li>
                            <li className="list-group-item">
                                <Button isExternal type="link" href="tel:+2122081996">021 - 2208 - 1996</Button>
                            </li>
                            <li className="list-group-item">
